function postProc_det(R_f, L_flat, L_curv, transitionLength, deltaX, deltaT, kappa, seN, animationSkip, h_drain_start, h_drain_end, h_critical_start, ...
...
[h x] = initialProfile(kappa,L_flat,L_curv,transitionLength,deltaX);       % get the initial conditions
...
[h_right_avg_j h_left_avg_j h_avg h_min h_centre_j v_thin_rim v_thin_centre avg_cr_thinningRate_fit h_cr_final ...
    h_cr_final_FullFilmavg drainageTime drainageTime_left drainageTime_right drainageTime_right_rupt drainageTime_left_rupt t_rupt] = ...
                                    loopingOverRealizations(x, tt, x_centre, locDimple_left, locDimple_right, res_limit, cr_thickness, ...
...
makeAnimation_det(animationSkip,kappa, L_flat, L_curv, transitionLength,deltaX, h_store, t_store);
