function [t_rupt x_rupt minH] = filmSolver(filmConfiguration, disjPress_switch, repulsion_coeff, repulsion_expon, L_flat,transitionLength,L_curv,N,deltaX,deltaT,kappa,Tmp,gx,h_adjusted,A,p,endTime,seN, cutOff_thickness);
