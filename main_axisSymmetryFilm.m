function [t_rupt drainageTime drainageTime_right drainageTime_right_rupt ...
    avg_cr_thinningRate_fit h_cr_final h_cr_final_FullFilmavg R_film_final Press vol_end area_end ratio_vol ratio_area t_series_rel h_fit_MTR bb h_c_tr] = main_axisSymmetryFilm(filmConfiguration, disjPress_switch, correctionLP_switch,...
                R_f, h0_init, A_vw, c1, c2, c3, gam, Rc, visc, L_flat, N_flat, deltaX, deltaT, transitionLength, h_drain_start, h_drain_end, h_critical_start,...
...
%     %% call the solver
% 
%     [t_rupt(m) x_rupt(m) minH(:,m) Press{m}] = filmSolver(filmConfiguration, disjPress_switch, correctionLP_switch, repulsion_coeff, repulsion_expon, vdW_repulsion, L_flat, R_f, Rc,...
...
[t_rupt drainageTime drainageTime_right drainageTime_right_rupt ...
    avg_cr_thinningRate_fit h_cr_final h_cr_final_FullFilmavg R_film_final Press vol_end area_end ratio_vol ratio_area t_series_rel h_fit_MTR bb h_c_tr] = postProc_det(filmConfiguration, disjPress_switch, correctionLP_switch,...
