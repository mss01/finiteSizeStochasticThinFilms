function [t_rupt x_rupt] = main_axisSymmetryFilm_parametric(filmConfiguration,disjPress_switch, kappa, L_flat, deltaX, deltaT, transitionLength, ...
                                                             ctimestep, Tmp, L_curv, endTime, seN, N_Reals, startRealization, cutOff_thickness, ...
                                                             correctionLP_switch, c1, c2, c3, R_f, Rc, res_limit,...
...
for m = 1:N_Reals      
    ...
    [t_rupt(m) x_rupt(m) minH(:,m)] = filmSolver(filmConfiguration, disjPress_switch, correctionLP_switch, repulsion_coeff, repulsion_expon, vdW_repulsion, L_flat, R_f, Rc,...
