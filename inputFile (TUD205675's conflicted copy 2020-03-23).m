    ...
    case 'axisSymmetricFilm'
        ...
        switch ExpOrPar
            case 'experimental'
                ...
                R_film =  [20 22 24 26 28 30 32 35 38 40 50 60 65 70 75 80 85 90 100 115 150 200 300 400 500 600 700 800 900 1000 1500 2000 3000 4000];   % radius of the film
            ...
            %                 c2 = 6e6;
                    ...
                    elseif isequal(repulsion_switch,'off')
                        ...
                        mk = strcat('h0_',num2str(h0_init*10^9),'nm','_Avw_',num2str(A_vw),'_ST_',num2str(gam),'_Rc_',num2str(Rc), ...
                                        '_100_25nm','_c1_',num2str(c1),'_c2_',num2str(c2),'clr');
                        mkdir(mk);
                        cd(mk);
                        copyfile('../../../../*.m', '.');
                        copyfile('../../../../dataRadoev1984.xlsx', '.');
